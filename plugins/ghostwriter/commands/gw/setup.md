...
Quick start:
  /gw:analyze {content_root}/example-file.md {pub-slug}
  /gw:humanize {content_root}/example-file.md {pub-slug} --quick
  /gw:humanize {content_root}/example-file.md {pub-slug}
  /gw:humanize-all {pub-slug}

To add another publication, run /gw:setup again.
```

...
Quick start:
  /ghostwriter:analyze {content_root}/example-file.md {pub-slug}
  /ghostwriter:rewrite {content_root}/example-file.md {pub-slug}
  /ghostwriter:humanize {content_root}/example-file.md {pub-slug}
  /ghostwriter:humanize-all {pub-slug}

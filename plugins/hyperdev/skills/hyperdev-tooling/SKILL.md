...
is HyperDev's *Tools Integration* and *Real-time Feedback* principles.
...
```bash
bash "${CLAUDE_PLUGIN_ROOT}/scripts/hyperdev-stack.sh" detect [dir]
bash "${CLAUDE_PLUGIN_ROOT}/scripts/hyperdev-stack.sh" list
```

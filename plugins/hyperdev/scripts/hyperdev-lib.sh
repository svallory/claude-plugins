...
# or the marker beside it. No marker-only fallback — HYPERDEV.md lives at the
...
description: $name uses the hyperdev bare space layout; worktrees in worktrees/, root is never committed
metadata:
  type: project
---

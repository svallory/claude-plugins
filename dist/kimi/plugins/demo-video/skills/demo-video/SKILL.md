...
1. **Read project options.** Check `.kimi-code/demo-video-skill.config.json` at the target project root.
...
| Per-project options | `.kimi-code/demo-video-skill.config.json` in the project |

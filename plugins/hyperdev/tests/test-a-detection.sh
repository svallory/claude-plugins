...
# has no marker-only fallback: HYPERDEV.md lives at the uncommittable bare
...
# itself must be rejected — even if a HYPERDEV.md is present inside it — and

...
#
# Usage: hyperdev-recommend.sh <project-dir> [aspect ...]
#
...
# 0 — this feeds /hyperdev:tools, which asks the user before touching anything.
...
# Detect ALL matching stacks, not first-match-wins like hyperdev-stack.sh

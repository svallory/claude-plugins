...
Quick start:
  /analyze {content_root}/example-file.md {pub-slug}
  /humanize {content_root}/example-file.md {pub-slug} --quick
  /humanize {content_root}/example-file.md {pub-slug}
  /humanize-all {pub-slug}

To add another publication, run /setup again.
```

---
name: plan-decompose
description: Use when running the Decompose phase of hyper plan — breaking design.md into ordered, dependent work units in tasks.md and creating tracked tasks for each. Triggers on "decompose the design", "break into tasks", "/hyperdev:plan <feature> decompose", or a spec dir with design.md but no tasks.md.
---
...
user the next step is `/hyperdev:plan <feature> develop` (the `plan-develop`
skill).

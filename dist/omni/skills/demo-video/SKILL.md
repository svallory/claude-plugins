...
1. **Read project options.** Check `.agents/demo-video-skill.config.json` at the target project root.
...
| Per-project options | `.agents/demo-video-skill.config.json` in the project |
